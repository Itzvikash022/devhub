    ...
    <Dialog {...props}>
      ...
      >
        <Command
          ...
          className="[&_[data-slot=command-input-wrapper]]:border-b [&_[data-slot=command-input-wrapper]]:px-3 [&_[data-slot=command-input]]:h-12 [&_[data-slot=command-list]]:max-h-[300px]"
        >
          {children}
        </Command>
      </DialogContent>
